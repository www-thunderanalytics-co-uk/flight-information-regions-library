class MathTools 
{
	...
	static isPointOnLine(point, line) 
	{
		...
		if (!(this.isGreaterThanOrEqualTo(py, minY) && this.isLessThanOrEqualTo(py, maxY) && this.isGreaterThanOrEqualTo(px, minX) && this.isLessThanOrEqualTo(px, maxX) )) return false;
		...
		if (params === undefined) return this.isEqual(p1x, px);
